...
import { 
  MapPinIcon, HomeModernIcon, CurrencyRupeeIcon, BedIcon, UsersIcon, HeartIcon, CalendarDaysIcon, MagnifyingGlassIcon
              ...
              <Card key={home.id} className="flex flex-col justify-between transform hover:scale-105 transition-transform duration-200">
                ...
                <div className="p-6 flex-grow">
                  ...
                  <div className="space-y-2 text-sm text-gray-600">
                    ...
                    <p className="flex items-center"><UsersIcon className="w-4 h-4 mr-2 text-emerald-500 flex-shrink-0" /> {t('homeCardCommunityPrefix')}: {t(COMMUNITY_PREFERENCE_OPTIONS.find(opt => opt.value === home.communityPreference)?.labelKey || home.communityPreference)}</p>
