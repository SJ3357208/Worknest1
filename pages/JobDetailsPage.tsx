...
import { 
  BuildingOfficeIcon, MapPinIcon, BriefcaseIcon, TagIcon, CurrencyRupeeIcon, CalendarDaysIcon, MagnifyingGlassIcon, ArrowLeftIcon, UserCircleIcon, ExclamationTriangleIcon 
