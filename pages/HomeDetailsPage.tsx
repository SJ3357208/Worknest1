...
import { 
  MapPinIcon, HomeModernIcon, CurrencyRupeeIcon, BedIcon, UsersIcon, HeartIcon, CalendarDaysIcon, MagnifyingGlassIcon, ArrowLeftIcon, UserCircleIcon, ExclamationTriangleIcon, ChevronLeftIcon, ChevronRightIcon
...
const HomeDetailsPage: React.FC<HomeDetailsPageProps> = ({ homes }) => {
            ...
            <div className="md:col-span-1 space-y-6">
                <Card className="p-6">
                    ...
                    <div className="space-y-3 text-sm text-gray-700">
                        ...
                        <p className="flex items-start"><UsersIcon className="w-5 h-5 mr-3 text-emerald-600 flex-shrink-0 mt-0.5" /> {t('homeCardCommunityPrefix')}: {t(COMMUNITY_PREFERENCE_OPTIONS.find(opt => opt.value === home.communityPreference)?.labelKey || home.communityPreference)}</p>
